...
angular.module('sdapsApp')
  .controller('MainCtrl', ["$scope", "$timeout", "Restangular", "toastr", "$upload", "$sce", "$location", function ($scope, $timeout, Restangular, toastr, $upload, $sce, $location) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
 ...
 */
angular.module('sdapsApp')
    .controller('DataentryCtrl', ["$scope", "$location", "toastr", "Restangular", "$timeout", "pdfDelegate", function ($scope, $location, toastr, Restangular,$timeout, pdfDelegate) {
 ...
 */
angular.module('sdapsApp')
  .controller('ReportsCtrl', ["$scope", "$timeout", "Restangular", "$sce", "$location", "toastr", function ($scope, $timeout, Restangular, $sce, $location, toastr) {
